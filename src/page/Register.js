        ...
        <div className="register-content">
          <div className="logo-section">
            ...
            <p className="welcome-text">
              {lang === 'th' ? 'ยินดีต้อนรับสู่ ReHabit!' : 'Welcome to ReHabit!'}
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} id="register-form">
            <div className="form-group">
              ...
              <input
                ...
                placeholder={lang === 'th' ? 'กรอกชื่อและนามสกุล' : 'Enter your name and surname'}
                required
              />
            </div>
          ...
          <div className="divider">
            <span>{lang === 'th' ? 'หรือสมัครสมาชิกด้วย' : 'Or sign up with'}</span>
          </div>
          ...
          <p>
            {lang === 'th' ? 'มีบัญชี ReHabit อยู่แล้ว?' : 'Already have ReHabit account?'}{' '}
